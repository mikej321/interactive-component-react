...
function Choices({ buttonList, onChange }) {
  return (
    <div className="button-container">
      {buttonList.map((button) => <button className="user-button" onClick={onChange} key={button}>{button}</button>)}
    </div>
  )
...
function App() {
  ...
  let [buttonAttributes, setButtonAttributes] = useState({
    buttons: [1, 2, 3, 4, 5],
    pickedChoice: null,
    submitted: false,
  })
  ...
  let selectChoice = (e) => {
    setButtonAttributes((prevState) => ({
      ...prevState,
      pickedChoice: Number(e.target.textContent),
    }))
  }
  ...
  return (
    <CSSTransition classNames={{
      main: "my-transition",
      appear: "my-transition-appear",
      appearActive: "my-transition-active-appear",
      appearDone: "my-transition-done-appear",
      enter: "my-transition-enter",
      enterActive: "my-transition-active-enter",
      enterDone: "my-transition-done-enter",
      exit: "my-transition-exit",
      exitActive: "my-transition-active-exit",
      exitDone: "my-transition-done-exit",
    }} in={buttonAttributes.submitted} timeout={200} appear>
      {
        !buttonAttributes.submitted ? (
          <div className="card-container">
            <div className="choice-screen">
              <div className="logo-container">
                <svg className="logo" width="17" height="16" viewBox="-4 -5 25 25" xmlns="http://www.w3.org/2000/svg"><path d="m9.067.43 1.99 4.031c.112.228.33.386.58.422l4.45.647a.772.772 0 0 1 .427 1.316l-3.22 3.138a.773.773 0 0 0-.222.683l.76 4.431a.772.772 0 0 1-1.12.813l-3.98-2.092a.773.773 0 0 0-.718 0l-3.98 2.092a.772.772 0 0 1-1.119-.813l.76-4.431a.77.77 0 0 0-.222-.683L.233 6.846A.772.772 0 0 1 .661 5.53l4.449-.647a.772.772 0 0 0 .58-.422L7.68.43a.774.774 0 0 1 1.387 0Z" fill="#FC7614"/></svg>
              </div>
